...
<!-- Mirrored from wp.alithemes.com/html/evara/evara-frontend/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Aug 2021 15:26:06 GMT -->
<head>
    <meta charset="utf-8">
                            ...
                            <div class="detail-gallery">
                                ...
                                <div class="product-image-slider">
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('public/imgs/shop/product-16-2.jpg') }}" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('public/imgs/shop/product-16-1.jpg') }}" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('public/imgs/shop/product-16-3.jpg') }}" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('public/imgs/shop/product-16-4.jpg') }}" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('public/imgs/shop/product-16-5.jpg') }}" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('public/imgs/shop/product-16-6.jpg') }}" alt="product image">
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('public/imgs/shop/product-16-6.jpg') }}" alt="product image">
                                    </figure>
                                ...
                                <div class="slider-nav-thumbnails pl-15 pr-15">
                                    <div><img src="{{ asset('public/imgs/shop/thumbnail-3.jpg') }}" alt="product image"></div>
                                    <div><img src="{{ asset('public/imgs/shop/thumbnail-4.jpg') }}" alt="product image"></div>
                                    <div><img src="{{ asset('public/imgs/shop/thumbnail-5.jpg.jpg') }}" alt="product image"></div>
                                    <div><img src="{{ asset('public/imgs/shop/thumbnail-6.jpg') }}" alt="product image"></div>
                                    <div><img src="{{ asset('public/imgs/shop/thumbnail-7.jpg') }}" alt="product image"></div>
                                    <div><img src="{{ asset('public/imgs/shop/thumbnail-8.jpg') }}" alt="product image"></div>
                                    <div><img src="{{ asset('public/imgs/shop/thumbnail-9.jpg') }}" alt="product image"></div>
                                </div>
                            </div>
                            <!-- End Gallery -->
                                    ...
                                    <div class="container">
                                        <div class="slider-1-height-3 slider-animated-1">
                                            ...
                                            <div class="slider-img">
                                                <img src="{{ asset('public/imgs/slider/slider-4.png') }}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="single-hero-slider single-animation-wrap">
                                    <div class="container">
                                        <div class="slider-1-height-3 slider-animated-1">
                                            ...
                                            <div class="slider-img">
                                                <img src="{{ asset('public/imgs/slider/slider-5.png') }}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                        <div class="banner-features wow fadeIn animated hover-up animated">
                            <img src="{{ asset('public/imgs/theme/icons/feature-1.png') }}" alt="">
                            <h4 class="bg-1">Free Shipping</h4>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                        <div class="banner-features wow fadeIn animated hover-up animated">
                            <img src="{{ asset('public/imgs/theme/icons/feature-2.png') }}" alt="">
                            <h4 class="bg-3">Online Order</h4>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                        <div class="banner-features wow fadeIn animated hover-up animated">
                            <img src="{{ asset('public/imgs/theme/icons/feature-3.png') }}" alt="">
                    ...
                    <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                        <div class="banner-features wow fadeIn animated hover-up animated">
                            <img src="{{ asset('public/imgs/theme/icons/feature-5.png') }}" alt="">
        ...
        <section class="banner-2 section-padding pb-0">
            <div class="container">
                <div class="banner-img banner-big wow fadeIn animated f-none">
                    <img src="{{ asset('public/imgs/banner/banner-4.png') }}" alt="">
                    ...
                    <div class="carausel-6-columns" id="carausel-6-columns">
                        <div class="card-1">
                            <figure class=" img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="{{ asset('public/imgs/shop/category-thumb-1.jpg') }}" alt=""></a>
                            </figure>
        ...
        <section class="banners mb-20">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="banner-img wow fadeIn animated">
                            <img src="{{ asset('public/imgs/banner/banner-2.png') }}" alt="">
                            <div class="banner-text">
                                <span>Sale off</span>
                    ...
                    <div class="col-lg-4 d-md-none d-lg-flex">
                        <div class="banner-img wow fadeIn animated  mb-sm-0">
                            <img src="{{ asset('public/imgs/banner/banner-3.png') }}" alt="">
                            <div class="banner-text">
                    ...
                    <div class="carausel-6-columns carausel-arrow-center" id="carausel-6-columns-2">
                        <div class="product-cart-wrap small hover-up">
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a href="shop-product-right.html">
                                        <img class="default-img" src="{{ asset('public/imgs/shop/product-2-1.jpg') }}" alt="">
...
<i class="fi-rs-eye"></i></a>
                        ...
                        <div class="product-cart-wrap small hover-up">
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a href="shop-product-right.html">
                                        <img class="default-img" src="{{ asset('public/imgs/shop/product-4-1.jpg') }}" alt="">
                                        <img class="hover-img" src="{{ asset('public/imgs/shop/product-4-2.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="product-action-1">
                                    <a aria-label="Quick view" class="action-btn small hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal">
<i class="fi-rs-eye"></i></a>
                        ...
                        <div class="product-cart-wrap small hover-up">
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a href="shop-product-right.html">
                                        <img class="default-img" src="{{ asset('public/imgs/shop/product-15-1.jpg') }}" alt="">
                                        <img class="hover-img" src="{{ asset('public/assets/imgs/shop/product-15-2.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="product-action-1">
                                    <a aria-label="Quick view" class="action-btn small hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal">
<i class="fi-rs-eye"></i></a>
                        ...
                        <div class="product-cart-wrap small hover-up">
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a href="shop-product-right.html">
                                        <img class="default-img" src="{{ asset('public/imgs/shop/product-3-1.jpg') }}" alt="">
                                        <img class="hover-img" src="{{ asset('public/imgs/shop/product-3-2.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="product-action-1">
                                    <a aria-label="Quick view" class="action-btn small hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal">
<i class="fi-rs-eye"></i></a>
                        ...
                        <div class="product-cart-wrap small hover-up">
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a href="shop-product-right.html">
                                        <img class="default-img" src="{{ asset('public/imgs/shop/product-9-1.jpg') }}" alt="">
                                        <img class="hover-img" src="{{ asset('public/imgs/shop/product-9-2.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="product-action-1">
                                    <a aria-label="Quick view" class="action-btn small hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal">
<i class="fi-rs-eye"></i></a>
                        ...
                        <div class="product-cart-wrap small hover-up">
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a href="shop-product-right.html">
                                        <img class="default-img" src="{{ asset('public/imgs/shop/product-7-1.jpg') }}" alt="">
                                        <img class="hover-img" src="{{ asset('public/imgs/shop/product-7-2.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="product-action-1">
                                    <a aria-label="Quick view" class="action-btn small hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal">
<i class="fi-rs-eye"></i></a>
                        ...
                        <div class="product-cart-wrap small hover-up">
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a href="shop-product-right.html">
                                        <img class="default-img" src="{{ asset('public/imgs/shop/product-1-1.jpg') }}" alt="">
                                        <img class="hover-img" src="{{ asset('public/imgs/shop/product-1-2.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="product-action-1">
                                    <a aria-label="Quick view" class="action-btn small hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 deal-co">
                        <div class="deal wow fadeIn animated mb-md-4 mb-sm-4 mb-lg-0" style="background-image: url('public/imgs/banner/menu-banner-7.jpg');">
                            <div class="deal-top">
                    ...
                    <div class="col-lg-6 deal-co">
                        <div class="deal wow fadeIn animated" style="background-image: url('public/imgs/banner/menu-banner-8.jpg');">
                            <div class="deal-top">
...
<i class="fi-rs-eye"></i></a>
    ...
    <script src="{{ asset('public/js/plugins/perfect-scrollbar.js') }}"></script>
    <script src="{{ asset('public/js/plugins/magnific-popup.js') }}"></script>
    <script src="{{ asset('public/js/plugins/select2.min.js') }}"></script>
    <script src="{{ asset('public/js/plugins/waypoints.js') }}"></script>
    <script src="{{ asset('public/js/plugins/counterup.js') }}"></script>
    <script src="{{ asset('public/js/plugins/jquery.countdown.min.js') }}"></script>
    <script src="{{ asset('public/js/plugins/images-loaded.js') }}"></script>
    <script src="{{ asset('public/js/plugins/isotope.js') }}"></script>
    <script src="{{ asset('public/js/plugins/scrollup.js') }}"></script>
    <script src="{{ asset('public/js/vendor/modernizr-3.6.0.min.js') }}"></script>
    <script src="{{ asset('public/js/plugins/jquery.theia.sticky.js') }}"></script>
    <script src="{{ asset('public/js/plugins/jquery.elevatezoom.js') }}"></script>
    <!-- Template  JS -->
...
<!-- Mirrored from wp.alithemes.com/html/evara/evara-frontend/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Aug 2021 15:26:07 GMT -->
</html>