...
<body>
    ...
    <script src="{{ asset('public/admin/js/vendors/jquery-3.6.0.min.js') }}"></script>
    ...
    <script src="{{ asset('public/admin/js/vendors/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('public/admin/js/vendors/select2.min.js') }}"></script>
    <script src="{{ asset('public/admin/js/vendors/perfect-scrollbar.js') }}"></script>
    <script src="{{ asset('public/admin/js/vendors/jquery.fullscreen.min.js') }}"></script>
    <script src="{{ asset('public/admin/js/vendors/chart.js') }}"></script>
    <!-- Main Script -->
    <script src="{{ asset('public/admin/js/main.js') }}" type="text/javascript"></script>
    <script src="{{ asset('public/admin/js/custom-chart.js') }}" type="text/javascript"></script>
    @stack('addproduct')
    @stack('producttable')
        </footer>
    </main>
